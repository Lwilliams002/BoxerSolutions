# RecurringBillingApi.SubscriptionDataAllOf
...
**billingDate** | **Date** | The date that the first payment will be charged. If the frequency is set to Monthly, this date will determine which day of the month the subsequent monthly charges will occur. Weekly and biweekly charges will occur on the same day of the week as the initial payment | [optional] 
