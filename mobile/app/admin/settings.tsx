...
type Settings = { companyName: string; phone: string; email: string; address: string; licenseNumber: string; defaultTaxRate: number; invoiceDueDays: number; chargeRecurringOnCompletion: boolean; appointmentReminderHours: number };
