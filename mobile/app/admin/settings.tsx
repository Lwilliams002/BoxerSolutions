...
type Settings = { companyName: string; phone: string; email: string; address: string; licenseNumber: string; defaultTaxRate: number; invoiceDueDays: number; appointmentReminderHours: number };
...
const styles = StyleSheet.create({ container: { padding: 16, paddingBottom: 40 }, title: { fontSize: 24, fontWeight: '900', color: colors.text, marginBottom: 6 }, hint: { fontSize: 13, color: colors.textMuted, marginBottom: 14, lineHeight: 18 }, input: { backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 12, padding: 12, marginBottom: 12, color: colors.text }, textArea: { minHeight: 80, textAlignVertical: 'top' } });
